...
import br.com.roger.data.vo.v1.security.AccountCredentialsVO;
import br.com.roger.services.AuthServices;
...
public class AuthController {
	...
	@SuppressWarnings("rawtypes")
	@Operation(summary = "Refresh token for authenticated user returns a token")
